...
if __name__ == "__main__":
    ...
    from rendering import render_episode_with_human_mode

    render_envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, args.num_envs + 8, args.num_envs + 7, args.capture_video, run_name, "human")]
    )

    render_episode_with_human_mode(render_envs, agent, device, args)
